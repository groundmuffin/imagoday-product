      ...
      >
        <defs>
          <linearGradient id="dividerGradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#96F1D9" stopOpacity="0" />
            <stop offset="30%" stopColor="#DFC938" stopOpacity="0.15" />
            <stop offset="50%" stopColor="#E8D856" stopOpacity="0.2" />
            <stop offset="70%" stopColor="#DFC938" stopOpacity="0.15" />
            <stop offset="100%" stopColor="#96F1D9" stopOpacity="0" />
          </linearGradient>
        </defs>
